...
class MultiBumpModificationAction(Action):
    ...
    def __init__(self,
        ...
        self.action_dict = {
            'upper bump 0 deviation': {'bound': [-0.05,  0.05],  'min_increment': 0.01,  'meaning': 'upper bump (0) location deviation from x=0.1'},
            'upper bump 0 height':    {'bound': [-0.005, 0.005], 'min_increment': 0.001, 'meaning': 'upper bump (0) height'},
            'upper bump 1 deviation': {'bound': [-0.20,  0.20],  'min_increment': 0.01,  'meaning': 'upper bump (1) location deviation from x=0.3'},
            'upper bump 1 height':    {'bound': [-0.005, 0.005], 'min_increment': 0.001, 'meaning': 'upper bump (1) height'},
            'upper bump 2 deviation': {'bound': [-0.20,  0.20],  'min_increment': 0.01,  'meaning': 'upper bump (2) location deviation from x=0.5'},
            'upper bump 2 height':    {'bound': [-0.005, 0.005], 'min_increment': 0.001, 'meaning': 'upper bump (2) height'},
            'upper bump 3 deviation': {'bound': [-0.20,  0.20],  'min_increment': 0.01,  'meaning': 'upper bump (3) location deviation from x=0.7'},
            'upper bump 3 height':    {'bound': [-0.005, 0.005], 'min_increment': 0.001, 'meaning': 'upper bump (3) height'},
            'upper bump 4 deviation': {'bound': [-0.05,  0.05],  'min_increment': 0.01,  'meaning': 'upper bump (4) location deviation from x=0.9'},
            'upper bump 4 height':    {'bound': [-0.005, 0.005], 'min_increment': 0.001, 'meaning': 'upper bump (4) height'},
            'lower bump 0 deviation': {'bound': [-0.05,  0.05],  'min_increment': 0.01,  'meaning': 'lower bump (0) location deviation from x=0.1'},
            'lower bump 0 height':    {'bound': [-0.005, 0.005], 'min_increment': 0.001, 'meaning': 'lower bump (0) height'},
            'lower bump 1 deviation': {'bound': [-0.20,  0.20],  'min_increment': 0.01,  'meaning': 'lower bump (1) location deviation from x=0.3'},
            'lower bump 1 height':    {'bound': [-0.005, 0.005], 'min_increment': 0.001, 'meaning': 'lower bump (1) height'},
            'lower bump 2 deviation': {'bound': [-0.20,  0.20],  'min_increment': 0.01,  'meaning': 'lower bump (2) location deviation from x=0.5'},
            'lower bump 2 height':    {'bound': [-0.005, 0.005], 'min_increment': 0.001, 'meaning': 'lower bump (2) height'},
            'lower bump 3 deviation': {'bound': [-0.20,  0.20],  'min_increment': 0.01,  'meaning': 'lower bump (3) location deviation from x=0.7'},
            'lower bump 3 height':    {'bound': [-0.005, 0.005], 'min_increment': 0.001, 'meaning': 'lower bump (3) height'},
            'lower bump 4 deviation': {'bound': [-0.05,   0.05], 'min_increment': 0.01,  'meaning': 'lower bump (4) location deviation from x=0.9'},
            'lower bump 4 height':    {'bound': [-0.005, 0.005], 'min_increment': 0.001, 'meaning': 'lower bump (4) height'},
        }
